...
* Salve o arquivo com um nome como `relatorio.Rmd`.
* Clique no botão **Knit** no RStudio.

Isso irá executar o seu código e gerar um arquivo `relatorio.html` contendo todos os outputs (prints e gráficos) que o seu script produz. Você pode então enviar este arquivo HTML para o seu professor.